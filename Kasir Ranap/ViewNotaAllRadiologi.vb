...
Public Class ViewNotaAllRadiologi

    Public Ambil_Data As String
    Public Form_Ambil_Data As String

    Private Sub ViewNotaAllRadiolgi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            ...
            Select Case Form_Ambil_Data
                Case "RadAll"
                    ...
                    da = New MySqlDataAdapter("SELECT
	                                                ...
	                                                totalTarif 
                                                FROM
	                                                vw_pasienradiologidetail
                                               WHERE 
                                                    noDaftar = '" & Home.txtNoReg.Text & "'", conn)
                    ds = New DataSet
                    da.Fill(dt)
                    ReportViewer1.LocalReport.DataSources.Clear()
                    Dim rpt As New ReportDataSource("CetakNotaRadiologi", dt)
                ...
                Case "RadPernota"
                    ...
                    da = New MySqlDataAdapter("SELECT
                                                ...
                                                FROM
	                                                vw_pasienradiologidetail
                                                WHERE
	                                                noTindakanRadiologiRajal = '" & Home.txtNoTinRad.Text & "'", conn)
                    ds = New DataSet
                    da.Fill(dt)
                    ReportViewer1.LocalReport.DataSources.Clear()
                    Dim rpt As New ReportDataSource("CetakNotaRadiologi", dt)
