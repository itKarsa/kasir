...
Public Class ViewNotaForPxRIK
    ...
    Function tampilVenti() As DataTable
        Call koneksiServer()
        Dim query As String = ""
        Dim cmd As MySqlCommand
        Dim dr As MySqlDataReader
        ...
        query = "SELECT spesifikasiKamar, alat, durasi
    ...
    Private Sub ViewNotaForPxRIK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim rptVenti As New ReportDataSource("CetakVenti", tampilVenti)
        ...
        ReportViewer1.LocalReport.DataSources.Add(rptVenti)
