...
Public Class ViewNotaAllTindakan

    Public Ambil_Data As String
    Public Form_Ambil_Data As String

    Private Sub ViewNotaAllTindakan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Ambil_Data = True Then
            Select Case Form_Ambil_Data
                Case "TindakanAll"
                    ...
                    Dim rpt As New ReportDataSource("CetakNotaTindakan", dt)
                    ReportViewer1.LocalReport.DataSources.Add(rpt)
                Case "TindakanPernota"
                    Dim dt As New DataTable
                    da = New MySqlDataAdapter("SELECT
	                                                noTindakanPasienRajal,
	                                                tindakan,
                                                ...
                                                FROM
	                                                vw_tindakanmedis
                                                WHERE
	                                                noTindakanPasienRajal = '" & Home.txtNoTindakan.Text & "'", conn)
                    ds = New DataSet
                    da.Fill(dt)
                    ReportViewer1.LocalReport.DataSources.Clear()
                    Dim rpt As New ReportDataSource("CetakNotaTindakan", dt)
